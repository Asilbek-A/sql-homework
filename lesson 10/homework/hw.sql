...
/*Inglizcha topshiriq:
Using the Employees and Departments tables, return the names and salaries of employees whose salary is greater than 50000, along with their department names.

O‘zbekcha topshiriq:
Employees va Departments jadvallaridan — oyligi 50000 dan katta bo‘lgan xodimlarning ismlari, oyligi va bo‘lim nomlarini chiqarish.
*/
...
/*Inglizcha topshiriq:
Using the Customers and Orders tables, display customer names and order dates for orders placed in the year 2023.

O‘zbekcha topshiriq:
Customers va Orders jadvallaridan — 2023-yilda berilgan buyurtmalar bo‘yicha mijozlarning ismlari va buyurtma sanasini chiqarish.
*/

Select FirstName + ' ' + LastName as CustomerName, OrderDate 
from Customers c 
...
Inglizcha topshiriq:
Using the Employees and Departments tables, show all employees along with their department names. Include employees who do not belong to any department.

O‘zbekcha topshiriq:
Employees va Departments jadvallaridan — barcha xodimlarni ularning bo‘limlari bilan chiqarish. Bo‘limsiz xodimlar ham chiqishi kerak.
*/
...
Inglizcha: List all suppliers and the products they supply. Show suppliers even if they don’t supply any product.

O‘zbekcha: Barcha yetkazib beruvchilar va ular yetkazib beradigan mahsulotlarni chiqarish. Mahsulot yetkazib bermaydigan yetkazib beruvchilar ham chiqishi kerak.
*/
...
Inglizcha: Return all orders and their corresponding payments. Include orders without payments and payments not linked to any order.

O‘zbekcha: Barcha buyurtmalar va ularga tegishli to‘lovlarni chiqarish. To‘lov qilinmagan buyurtmalar va buyurtmaga ulanmagan to‘lovlar ham chiqsin.
*/
...
Inglizcha: Show each employee's name along with the name of their manager.

O‘zbekcha: Har bir xodimning ismini va uning menejerining ismini ko‘rsatish.
*/
...
Inglizcha: List the names of students who are enrolled in the course named 'Math 101'.

O‘zbekcha: “Math 101” kursiga yozilgan talabalarni ko‘rsatish.
*/
...
/* Task 8
Inglizcha: Find customers who have placed an order with more than 3 items. Return their name and the quantity they ordered.

O‘zbekcha: 3 tadan ortiq mahsulot buyurtma qilgan mijozlarning ismi va buyurtma miqdorini chiqarish.
*/
...
/* Task 9
Inglizcha: List employees working in the 'Human Resources' department.

O‘zbekcha: “Human Resources” bo‘limida ishlaydigan xodimlarni ko‘rsatish.
*/
...
Employees va Departments jadvallaridan foydalanib, 5 tadan ko‘p xodim ishlaydigan bo‘lim nomlarini qaytaring.
*/ 

select count (e.Name) as Name, d.DepartmentName 
from Employees e 
join Departments d on e.DepartmentID = d.DepartmentID
...
Products va Sales jadvallaridan foydalanib, hech qachon sotilmagan mahsulotlarni toping.
*/
...
Customers va Orders jadvallaridan foydalanib, kamida bitta buyurtma qilgan mijozlarni qaytaring.
*/
...
Employees va Departments jadvallaridan foydalanib, faqat xodim ham, bo‘lim ham mavjud bo‘lgan yozuvlarni ko‘rsating.
*/ 
...
Employees jadvalidan foydalanib, bir xil menejerdan hisobot oladigan xodimlar juftliklarini toping.
*/ 
...
Orders va Customers jadvallaridan foydalanib, 2022-yilda berilgan barcha buyurtmalarni mijoz ismi bilan birga ko‘rsating.
*/ 
...
Employees va Departments jadvallaridan foydalanib, 'Sales' bo‘limida ishlaydigan va oyligi 60000 dan yuqori bo‘lgan xodimlarni qaytaring.
*/ 
...
Orders va Payments jadvallaridan foydalanib, faqat to‘lovi mavjud bo‘lgan buyurtmalarni qaytaring.
*/ 
