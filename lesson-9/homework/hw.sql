...
Puzzle-1 
Select ProductName, SupplierName from Products p cross join Suppliers s 

Puzzle-2
Select DepartmentName, Name, employees from Departments d cross join  Employees e
...
Puzzle-4
SELECT FirstName + ' ' + LastName AS CustomerName, O.OrderID
FROM Orders O
...
--O‘zbekcha topshiriq:
--Buyurtmalar va Mahsulotlar jadvallaridan — buyurtma qilingan miqdor zaxiradagi miqdordan katta bo‘lgan buyurtmalarni ko‘rsating.
...
--O‘zbekcha topshiriq:
--Mijozlar va Savdolar jadvallaridan — sotuv summasi 500 yoki undan katta bo‘lgan mijoz nomlari va mahsulot IDlarini ko‘rsating.

select FirstName + ' ' + LastName as CustomerName,SaleAmount, ProductID  from Customers c join Sales s on c.CustomerID  = s.CustomerID 
...
--O‘zbekcha topshiriq:
--Kurslar, Ro‘yxatdan o‘tishlar va Talabalar jadvallaridan — talabalar va ularning ro‘yxatdan o‘tgan kurslarini chiqarish.

select CourseName, Name from Courses c join Enrollments e on c.CourseID = e.CourseID
...
--O‘zbekcha topshiriq:
--Mahsulotlar va Yetkazib beruvchilar jadvallaridan — nomida “Tech” so‘zi bor bo‘lgan yetkazib beruvchilar va ularning mahsulotlarini chiqaring.-
...
--O‘zbekcha topshiriq:
--Buyurtmalar va To‘lovlar jadvallaridan — to‘lov summasi umumiy summadan kam bo‘lgan buyurtmalarni ko‘rsating.
...
O‘zbekcha topshiriq:
Xodimlar va Bo‘limlar jadvallaridan — har bir xodim uchun uning bo‘limi nomini ko‘rsating.
*/
...
O‘zbekcha topshiriq:
Mahsulotlar va Kategoriyalar jadvallaridan — kategoriyasi “Electronics” yoki “Furniture” bo‘lgan mahsulotlarni chiqaring.
*/
...
O‘zbekcha topshiriq:
Savdolar va Mijozlar jadvallaridan — “USA” mamlakatidan bo‘lgan mijozlarning barcha savdolarini chiqaring.
*/
...
O‘zbekcha topshiriq:
Buyurtmalar va Mijozlar jadvallaridan — “Germany” davlatidan bo‘lgan mijozlarning umumiy summasi 100 dan katta bo‘lgan buyurtmalarini chiqaring.
*/
